    ...
    if fine_tune_encoder:
        ...
        with torch.no_grad():
            ...
            if save_embeddings:
                ...
                np.savez(
                    os.path.join(embedding_save_path, "x_y_groups_embedding.npz"), array1=x_repr_all, array_2=y, array_3=groups
                )
...
if __name__ == "__main__":
    ...
    classifier_group.add_argument("--classifier_epochs", type=int, default=25,
                                 help="Number of epochs for fine-tuning training")
    ...
    classifier_group.add_argument("--classifier_batch_size", type=int, default=32,
                                 help="Batch size for fine-tuning classifier training")
