...
python3 tstcc_train_cleaned_cv.py --seed 1 --tcc_epochs 2 --label_fraction 0.25 --use_s3_layers --force_retraining --fs 700
#python3 tstcc_train_cleaned_cv.py --seed $1 --tcc_epochs 2 --label_fraction 0.5 --use_s3_layers --fs 700
#python3 tstcc_train_cleaned_cv.py --seed $1 --tcc_epochs 2 --label_fraction 1.0 --use_s3_layers --fs 700
