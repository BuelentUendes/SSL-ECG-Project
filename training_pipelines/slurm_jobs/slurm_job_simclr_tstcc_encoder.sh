...
python3 simclr_train_cleaned_cv.py --seed $1 --epochs 40 --label_fraction 0.1 --force_retraining --temperature 0.3 --use_tstcc_encoder
python3 simclr_train_cleaned_cv.py --seed $1 --epochs 40 --label_fraction 0.01 --temperature 0.3 --use_tstcc_encoder
python3 simclr_train_cleaned_cv.py --seed $1 --epochs 40 --label_fraction 0.025 --temperature 0.3 --use_tstcc_encoder
python3 simclr_train_cleaned_cv.py --seed $1 --epochs 40 --label_fraction 0.05 --temperature 0.3 --use_tstcc_encoder
python3 simclr_train_cleaned_cv.py --seed $1 --epochs 40 --label_fraction 0.25 --temperature 0.3 --use_tstcc_encoder
python3 simclr_train_cleaned_cv.py --seed $1 --epochs 40 --label_fraction 0.5 --temperature 0.3 --use_tstcc_encoder
