...
python3 tstcc_train_cleaned_cv.py --seed $1 --tcc_epochs 40 --label_fraction 0.1 --force_retraining
...
#      sbatch --job-name=ECG_TSTCC_TL_seed_${SEED} \
#             --output=ecg_tstcc_TL_${SEED}_%j.out \
#             --error=ecg_tstcc_TL_${SEED}_%j.err \
#             --time=48:00:00 \
#             ./slurm_jobs/slurm_job_tstcc_training_loss.sh $SEED
#  done
##