...
#      sbatch --job-name=ECG_TS2Vec_seed_TL_${SEED} \
#             --output=ecg_ts2vec_TL_${SEED}_%j.out \
#             --time=60:00:00 \
#             --error=ecg_ts2vec_TL_${SEED}_%j.err \
#             ./slurm_jobs/slurm_job_ts2vec_training_loss.sh $SEED
#  done
##