#!/bin/bash
#SBATCH --job-name=ECG_AUX_TS2Vec
#SBATCH --time=60:00:00
#SBATCH -N 1
#SBATCH --gres=gpu:1
#SBATCH --mail-type=BEGIN,END
#SBATCH --mail-user=b.uendes@vu.nl
#SBATCH --output=ecg_aux_ts2vec_%j.out
#SBATCH --error=ecg_aux_ts2vec_%j.err
#SBATCH -C A5000
...
python3 ts2vec_train_cleaned_cv.py --seed 12345 --ts2vec_epochs 2 --label_fraction 0.1 --ts2vec_temporal_unit 0
...
#python3 ts2vec_train_cleaned_cv.py --seed $1 --ts2vec_epochs 40 --label_fraction 0.25
#python3 ts2vec_train_cleaned_cv.py --seed $1 --ts2vec_epochs 40 --label_fraction 0.5
