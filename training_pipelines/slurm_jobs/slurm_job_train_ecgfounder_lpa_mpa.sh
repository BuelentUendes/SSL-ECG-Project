#!/bin/bash
#SBATCH --job-name=ECG_Founder_lpa_mpa
#SBATCH -N 1
#SBATCH --gres=gpu:1
...
#      sbatch --job-name=ECG_MPA_LPA_Founder_seed_${SEED} \
#             --output=ecg_lpa_mpa_founder_${SEED}_%j.out \
#             --error=ecg_lpa_mpa_founder_${SEED}_%j.err \
#             --time=72:00:00 \
#             ./slurm_jobs/slurm_job_train_ecgfounder_lpa_mpa.sh $SEED
#  done
##