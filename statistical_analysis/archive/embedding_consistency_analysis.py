...
def main():
    ...
    for pair_name, pair_results in results.items():
        ...
        if 'overall_discrimination' in pair_results:
            ...
            print(f"      ROC-AUC: {overall['roc_auc_mean']:.3f} ± {overall['roc_auc_se']:.3f}")
            print(f"      PR-AUC: {overall['pr_auc_mean']:.3f} ± {overall['pr_auc_se']:.3f}")
            print(f"      Accuracy: {overall['accuracy_mean']:.3f} ± {overall['accuracy_se']:.3f}")
